<template>
  <nav class=" fixed w-full p-6 bg-transparent">
    <div class="flex items-center justify-between">
      ...
      <img width="40px" class="mr-2" src="/mountain.png">

       <h1 class="text-2xl font-Times New Roman">
      ...
      <div class="md:hidden">
        <button @click="drawer">
          <svg 
            class="h-8-8 w fill-current text-black"
      ...
      <div class="hidden md:block">
        <ul class="flex space-x-8 text-sm font-sans">
          <li><NuxtLink class="font-Times New Roman: text-base " to="/">Home</NuxtLink></li>
          <li><NuxtLink class="font-Times New Roman text-base" to="/Trips">Trips</NuxtLink></li>
          <li><NuxtLink class="cta bg-blue-600 hover:bg--600 px-3 py-2 rounded text-black font-Times New Roman: text-base" to="/About-me">About me</NuxtLink></li>
      ...
      <aside class="p-5 transform top-0 left-0 w-64 bg-white fixed h-full overflow-auto ease-in-out transition-all duration-300 z-30" :class="isOpen ? 'translate-x-0' : '-translate-x-full'">
        ...
        <ul class="divide-y font-sans">
          ...
          <li><a href="#" @click="isOpen = false" class="my-4 inline-block">Trips</a></li>
          <li><a href="#" @click="isOpen = false" class="my-4 inline-block">About me</a></li>
...
<style>
  .nuxt-link-exact-active {
    border-bottom: 2px solid rgb(38, 0, 255);
    padding-bottom: 5px;
  }
</style> 